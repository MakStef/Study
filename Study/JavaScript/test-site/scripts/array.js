...
Методи масивів:
    ...
    .forEach(<функція>) - проходить по всім елементам масиву, виконуючи задану функцію, в ролі аргументів для котрої передаються три значення: <елемент>, <індекс>, <ім'я масиву>.
*/
myArray.pop()
alert(myArray)
